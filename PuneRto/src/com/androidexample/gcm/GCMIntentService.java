...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        Log.d("NAME", MainActivityImportatnt.name);
        aController.register(context, MainActivityImportatnt.name, MainActivityImportatnt.email, registrationId);
    }
    ...
    private static void generateNotification(Context context, String message) {
        ...
        Intent notificationIntent = new Intent(context, MainActivityImportatnt.class);
