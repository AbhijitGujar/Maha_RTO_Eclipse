...
public class ActivityLearnLicAppointment_Tab4 extends Activity implements OnItemSelectedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		etdate1 = (EditText)findViewById(R.id.date_doc1);
		etdate2 = (EditText)findViewById(R.id.date_doc2);
		etdate3 = (EditText)findViewById(R.id.date_doc3);
		etdate4 = (EditText)findViewById(R.id.date_doc4);
		etdate5 = (EditText)findViewById(R.id.date_doc5);
