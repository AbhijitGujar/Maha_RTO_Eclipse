...
public class MainActivity extends Activity {
	...
	public static String[] rtoContentNameList = { "Motor Vehicle Department",
			...
			"New Projects", "School Bus", "UserManual", " Credits", "blank1",
			 };
	public static int[] rtoContenImages = {
			...
			R.drawable.school_bus, R.drawable.user_manual, R.drawable.credits,
			R.drawable.blank1, };
	...
	public static int[] rtoContenImagesMarathi = {
			...
			R.drawable.marathi_user_manual, R.drawable.marathi_credits,
			R.drawable.blank1 };
